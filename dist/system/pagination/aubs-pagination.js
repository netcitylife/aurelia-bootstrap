...
System.register(["aurelia-framework", "../utils/bootstrap-options"], function (_export, _context) {
    ...
    var bindable, bindingMode, customElement, useView, bootstrapOptions, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, AubsPaginationCustomElement;
    ...
    return {
        ...
        execute: function () {
            _export("AubsPaginationCustomElement", AubsPaginationCustomElement = (_dec = customElement('aubs-pagination'), _dec2 = useView('./aubs-pagination.html'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = function () {
            ...
            }(), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "currentPage", [_dec3], {
                enumerable: true,
                initializer: null
