...
System.register(['aurelia-framework'], function (_export, _context) {
    ...
    var inject, bindable, bindingMode, customAttribute, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, AubsBtnRadioCustomAttribute;
    ...
    return {
        ...
        execute: function () {
            _export('AubsBtnRadioCustomAttribute', AubsBtnRadioCustomAttribute = (_dec = inject(Element), _dec2 = customAttribute('aubs-btn-radio'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = function () {
